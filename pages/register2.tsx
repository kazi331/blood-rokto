      ...
      <div className="container mx-auto flex items-center justify-center py-20" >
        <div className="py-4 min-w-min border p-8">
          ...
          <FormProvider {...methods} >
            <form className={styles.RegisterForm} onSubmit={methods.handleSubmit(onSubmit)}>
                ...
                <div className={styles.field}>
                  ...
                  <div className={styles.fieldInput} >
                    <div>
                      ...
                      {errors.fname && <span className={styles.error}>This field is required</span>}
                    </div>
                    <div>
                      <input {...register("lname", { required: true })} type="text" id="lname" placeholder='Last name' />
                      {errors.lname && <span className={styles.error}>This field is required</span>}
                    </div>
                  </div>
                </div>
